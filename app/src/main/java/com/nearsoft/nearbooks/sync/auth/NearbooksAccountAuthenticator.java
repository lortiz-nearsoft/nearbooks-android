 ...
 */
public class NearbooksAccountAuthenticator extends AbstractAccountAuthenticator {

    private Context mContext;

    public NearbooksAccountAuthenticator(Context context) {
        super(context);
        mContext = context;
    }
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response, Account account,
        ...
        if (!authTokenType.equals(AccountGeneral.AUTH_TOKEN_TYPE_READ_ONLY) &&
                !authTokenType.equals(AccountGeneral.AUTH_TOKEN_TYPE_FULL_ACCESS)) {
...
//        }
    ...
    public String getAuthTokenLabel(String authTokenType) {
        if (AccountGeneral.AUTH_TOKEN_TYPE_FULL_ACCESS.equals(authTokenType)) {
            return AccountGeneral.AUTH_TOKEN_TYPE_FULL_ACCESS_LABEL;
        } else if (AccountGeneral.AUTH_TOKEN_TYPE_READ_ONLY.equals(authTokenType)) {
