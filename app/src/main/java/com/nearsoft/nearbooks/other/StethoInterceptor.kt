package com.nearsoft.nearbooks.other
...
/**
 * Provides easy integration with [OkHttp](http://square.github.io/okhttp/) 2.2.0+
 * by way of the new [Interceptor](https://github.com/square/okhttp/wiki/Interceptors)
 * system. To use:
 *
...
class StethoInterceptor : Interceptor {
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        val requestId = mNextRequestId.andIncrement.toString()
        ...
        if (mEventReporter.isEnabled) {
            ...
            if (responseStream != null) {
                response = response.newBuilder().body(ForwardingResponseBody(body, responseStream)).build()
            }
        }
